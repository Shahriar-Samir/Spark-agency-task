const Banner5 = () => {
  return (
    <div className="w-full h-[140vh] lg:h-[100vh] bg-[linear-gradient(to_bottom,rgba(0,0,0,0.2),rgba(0,0,0,0.2)),url('/images/banner5.jpg')] bg-no-repeat bg-cover relative flex justify-center items-center p-[5%] ">
      ...
      <section className="w-full flex flex-col justify-center md:flex-row items-center md:gap-16 mt-32 xl:mt-0">
        ...
        <div className="text-white font-inter md:w-1/2 mt-28">
